...
//        for (int i = 0; i < expenseReportRequest.getExpenseReportDetailCreateRequests().size(); i++) {
//            expenseReportDetails.add(ExpenseReportDetail.of(
//                    expenseReportRequest.getExpenseReportDetailCreateRequests().get(i).getItem(),
//                    expenseReportRequest.getExpenseReportDetailCreateRequests().get(i).getAmount(),
//                    expenseReportRequest.getExpenseReportDetailCreateRequests().get(i).getNote()
//            ));
//        }
