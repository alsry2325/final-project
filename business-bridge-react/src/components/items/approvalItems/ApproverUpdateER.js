...
function
ApproverUpdateER({expenseReport, form, setForm}) {
    ...
    return (
        <>
            ...
            {/* 기존 값 조회 */}
            {!approvers.length && expenseReport.approvers &&
                     expenseReport.approvers.map((approver) => (
                        <div className="approver" key={approver.approverId}>
                            ...
                            <div className="approve-box">{approver.approverName}</div>
            ...
            {approvers.length &&
                approvers.map((approver) => (
                    <div className="approver" key={approver.emplyCode}>
                        <div className="approver-position">{approver.positionName}</div>
                        <div className="approve-box">{approver.emplyName}</div>
                        <div className="approval-date"></div>
                    </div>
                ))}
        </>
...
export default ApproverUpdateER;