...
/* 액션 함수 */
export const { employee : {  loginSuccess, loginFailure, getMyPage,getEmployees, postEmployeeSuccess,postEmployeeFailure,getEmployee,putEmployeeSuccess,getSerachEmployees } } = createActions({
...
const memberReducer = handleActions({
    ...
    [GET_EMPLOYEES] : (state,{ payload }) => ({...state, ...payload, postEmployeeSuccess : undefined}),  //복사해서 이어감
