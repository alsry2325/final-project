...
- 자체 로그인 및 비밀번호 찾기
- 사원번호와 이메일을 통한 로그인
- 임시 비밀번호 발급 및 로그아웃 <br>
#### B) 마이페이지 
- 사원 정보 수정 (부서, 직급, 개인 이메일, 비밀번호 등)
- 프로필 사진 등록 및 수정, 삭제 <br>
#### C) 공지 게시판
- 게시판 글 등록, 수정, 삭제
- 첨부파일 기능 및 검색 기능 제공 <br>
#### D) 주소록 조회
- 사원 정보 조회 (이름, 부서, 직급, 이메일, 휴대폰 번호 등)
- 퇴사 처리 및 권한 관리 (전자결재 문서 열람 권한 등) <br>
#### E) 쪽지
- 쪽지 작성, 수신 및 삭제
- 받은 쪽지함, 보낸 쪽지함 관리
- 중요 쪽지 보관함 제공 <br>
#### F) 캘린더
- 개인, 부서, 사내 일정 관리 (연차, 반차, 회의, 거래처 미팅 등)
- 임원 일정 관리 (임원 회의 및 워크샵 등) <br>
#### G) 전자결재
- 결재서류 형식 지정 및 자동 결재
- 결재 현황 조회 및 결재 서류 열람 기능 <br>
#### H) 견적서 관리
- 견적 진행 상태 표시 및 PDF/엑셀 내보내기
- 견적서 작성/수정/삭제 및 공유 기능 (이메일, SNS)
- 견적서 등록 시 설정 기능 (수량, 단가, 부가세 등) <br>
#### I) 고객관계관리 (CRM)
- 거래처 등록 및 정보 조회
- 영업 관리 및 고객 등급 관리
